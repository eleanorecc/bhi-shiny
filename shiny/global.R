...
source(here::here("shiny", "modules", "map_card.R"))
source(here::here("shiny", "modules", "barplot_card.R"))
source(here::here("shiny", "modules", "flowerplot_card.R"))
source(here::here("shiny", "modules", "scorebox_card.R"))
...
full_scores_csv <- readr::read_csv(here("data", "scores.csv"))
goals_csv <- readr::read_csv(here("data", "plot_conf.csv"))

regions_df <- readr::read_csv(here("data", "regions.csv"))
subbasins_df <- readr::read_csv(here("data", "basins.csv"))

rgns_shp <- make_rgn_sf(
  bhi_rgns_shp = read_rds(here("data", "regions.rds")), 
  scores_csv = full_scores_csv, 
  dim = "score", 
  year = assess_year
)
subbasins_shp <- make_subbasin_sf(
  subbasins_shp = read_rds(here("data", "subbasins.rds")), 
  scores_csv = full_scores_csv, 
  dim = "score", 
  year = assess_year
)
