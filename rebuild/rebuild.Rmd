...
## flowerplot configuration table
FlowerConf <- read_csv(sprintf("%s/%s/conf/plot_config.csv", gh_raw_bhi, scenario_folder)) %>% 
  select(goal, parent, name, name_flower, weight, order_hierarchy)
